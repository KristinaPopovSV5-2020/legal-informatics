...
@Component({
  selector: 'app-weapon-law-page',
  templateUrl: './weapon-law-page.component.html',
  styleUrl: './weapon-law-page.component.css',
  standalone: false
})
export class WeaponLawPageComponent implements OnInit {
  ...
  fetchCase() {
    this.cbrService.getLawAkomaNtoso("oruzje").subscribe(data => { 
      try {
